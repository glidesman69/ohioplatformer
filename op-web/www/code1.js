...
gdjs.menuCode.GDloginButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDplayButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDcreditsButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDquitButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDoptionsButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDcheatsButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDcheatactivationdebugbuttonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDhelpButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.condition1IsTrue_1.val = false;
{
gdjs.menuCode.condition0IsTrue_1.val = !(gdjs.playerAuthentication.isAuthenticated());
if( gdjs.menuCode.condition0IsTrue_1.val ) {
    gdjs.menuCode.conditionTrue_1.val = true;
}
}
{
gdjs.menuCode.condition1IsTrue_1.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)) == 0;
...
{
gdjs.menuCode.condition1IsTrue_1.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)) == 1;
if( gdjs.menuCode.condition1IsTrue_1.val ) {
    gdjs.menuCode.conditionTrue_1.val = true;
}
}
...
{
{gdjs.menuCode.conditionTrue_1 = gdjs.menuCode.condition0IsTrue_0;
gdjs.menuCode.GDcheatsButtonObjects2_1final.length = 0;gdjs.menuCode.condition0IsTrue_1.val = false;
{
...
gdjs.menuCode.GDcheatsButtonObjects3.length = k;if( gdjs.menuCode.condition0IsTrue_1.val ) {
    gdjs.menuCode.conditionTrue_1.val = true;
    for(var j = 0, jLen = gdjs.menuCode.GDcheatsButtonObjects3.length;j<jLen;++j) {
...
gdjs.menuCode.GDloadsaveButtonObjects2.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
...
gdjs.menuCode.GDchangelogButtonObjects1.length = k;}if ( gdjs.menuCode.condition0IsTrue_0.val ) {
{
{gdjs.menuCode.conditionTrue_1 = gdjs.menuCode.condition1IsTrue_0;
gdjs.menuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(16347828);
}
}}
if (gdjs.menuCode.condition1IsTrue_0.val) {
...
gdjs.menuCode.GDxbuttonObjects1.length = k;}if (gdjs.menuCode.condition0IsTrue_0.val) {
